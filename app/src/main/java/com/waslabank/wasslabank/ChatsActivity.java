    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ChatsAdapter(chats, this, new ChatsAdapter.OnItemClicked() {
            ...
            public void setOnItemClicked(int position) {
                ...
                mConnectorGetRide.getRequest("ChatsActivity", "http://www.as.cta3.com/waslabank/api/get_request?id=" + chats.get(position).getRequestId());
        ...
        mConnector.getRequest("ChatsActivity", "http://www.as.cta3.com/waslabank/api/get_chat?user_id=" + Helper.getUserSharedPreferences(this).getId());
