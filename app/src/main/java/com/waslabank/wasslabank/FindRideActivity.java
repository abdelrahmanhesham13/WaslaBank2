...
public class FindRideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConnector.getRequest(TAG,"https://code-grow.com/waslabank/api/get_requests?lat_from=" + mLatFrom + "&long_from=" + mLonFrom
                + "&lat_to=" + mLatTo + "&long_to=" + mLonTo+ "&user_id=" +Helper.getUserSharedPreferences(this).getId() + "&type=" +"search");
       // Log.d("TTTT ","onCreate:---> "+"https://code-grow.com/waslabank/api/get_requests?lat_from=" + mLatFrom + "&long_from=" + mLonFrom + "&lat_to=" + mLatTo + "&long_to=" + mLonTo);
        Log.d("TTTT", "onCreate: "+"https://code-grow.com/waslabank/api/get_requests?lat_from=" + mLatFrom + "&long_from=" + mLonFrom + "&lat_to=" + mLatTo + "&long_to=" + mLonTo);
    }
}
