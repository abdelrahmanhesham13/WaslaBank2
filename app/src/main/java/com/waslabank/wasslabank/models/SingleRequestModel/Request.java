...
public class Request {
    ...
    public Integer getUserLongitude() {
        return userLongitude;
    }

    public void setUserLongitude(Integer userLongitude) {
        this.userLongitude = userLongitude;
    }

    public Integer getUserLatitude() {
        return userLatitude;
    }

    public void setUserLatitude(Integer userLatitude) {
